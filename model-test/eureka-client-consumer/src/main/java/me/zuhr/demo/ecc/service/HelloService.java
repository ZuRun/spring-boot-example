...
public class HelloService {
    ...
    public String test() {
        ResponseEntity<Map> rmap = restTemplate.getForEntity("http://" + ServiceNameEnum.ECP.getValue() + "/handle", Map.class);


        ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://" + ServiceNameEnum.ECP.getValue() + "/hello", String.class);
