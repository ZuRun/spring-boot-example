...
public enum HttpStatus {
    ...
    public org.springframework.http.HttpStatus.Series series() {
        return org.springframework.http.HttpStatus.Series.valueOf(this);
    }
    ...
    public static org.springframework.http.HttpStatus valueOf(int statusCode) {
        for (org.springframework.http.HttpStatus status : values()) {
    ...
    public enum Series {
        ...
        public static org.springframework.http.HttpStatus.Series valueOf(int status) {
            int seriesCode = status / 100;
            for (org.springframework.http.HttpStatus.Series series : values()) {
